...
def findline(each,aim1_list,aim2_list):
    ...
    if each == aim1_list_0[0]:
        ...
        b=[each]
        b.extend(findline(aim1_list_0[1],aim3_list,aim2_list))
        return b
    else:
        aim1_list.pop(0)
        if aim1_list != []:
            b=[]
            b.extend(findline(each,aim1_list,aim2_list))
            return b
        else:
            return [each]
...
copy_aim1_list = deepcopy(aim1_list)
print(copy_aim1_list)
