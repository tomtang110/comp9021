...
class Solitaire(tk.Tk):
    ...
    def rules_help(self):
        tkinter.messagebox.showinfo('Rules of the game',
            ...
            'and fill a hole, moving either horizontally or vertically.\n\n'
    ...
    def defined_problems_help(self):
        tkinter.messagebox.showinfo('Defined problems',
            ...
            ' - Click on the button that displays "Demonstrate solution". This will start the '
            'animation of a solution that can be paused and resumed at will by clicking on the '
            'rightmost button, and which will have to eventually be stopped by clicking on the '
            'button that displays "Stop demonstration" as it starts from the initial configuration '
            'again after only one peg is left and the game is over.\n'
            ' - Click on the button that displays "Create own problem" to try and solve the problem '
            'manually, possibly after having modified it, or by setting a new problem by first '
            'clicking on the button which displays "Clear".'
                                    )
    ...
    def reaction_to_clicks_help(self):
        tkinter.messagebox.showinfo('Reaction to clicks',
            ...
            'as long as the button that displays "Stop demonstration" will not have been '
            'clicked.\n\n'
            ...
            'If the third button displays "Stop playing", then clicking on the board allows one '
            'to:\n'
...
class Configuration:
    def __init__(self):
        locations = set.union(*tuple(map(set, (range(37, 58, 10), range(26, 67, 10),
        ...
        self.problems = ((35, 43, 44, 45, 46, 55),
                         ...
                         (14, 22, 24, 26, 33, 34, 35, 41, 42, 43, 44, 45, 46, 47, 53, 54, 55, 62,
                                                                                          64, 66, 74
                         ),
                         (14, 23, 24, 25, 32, 34, 36, 41, 42, 43, 44, 45, 46, 47, 52, 54, 56, 63,
                                                                                          64, 65, 74
                         ),
                         (14, 23, 24, 25, 32, 33, 34, 35, 36, 42, 43, 44, 45, 46, 47, 52, 53, 54,
                                                                              55, 56, 63, 64, 65, 74
                         ),
                         (14, 23, 24, 25, 32, 33, 34, 35, 36, 41, 42, 43, 45, 46, 47, 52, 53, 54,
                                                                              55, 56, 63, 64, 65, 74
                         ),
        ...
        self.problem_solutions = (((45, 65), (43, 45), (35, 55), (65, 45), (46, 44)),
                                  ((43, 41), (45, 43), (24, 44), (44, 42), (64, 44), (41, 43),
                                                                                  (43, 45), (46, 44)
                                  ),
                                  ((53, 55), (55, 35), (33, 53), (63, 43), (44, 42), (35, 33),
                                                                                  (23, 43), (42, 44)
                                  ),
                                  ((45, 25), (37, 35), (57, 37), (34, 36), (37, 35), (25, 45),
                                                              (46, 66), (54, 56), (66, 46), (46, 44)
                                  ),
                                  ((31, 33), (51, 53), (43, 63), (41, 43), (33, 53), (63, 43),
                                         (44, 42), (46, 44), (25, 45), (45, 43), (65, 45), (42, 44),
                                                                                  (44, 46), (47, 45)
                                  ),
                                  ((55, 53), (74, 54), (53, 55), (55, 57), (57, 37), (35, 33),
                                         (14, 34), (33, 35), (36, 56), (44, 46), (56, 36), (25, 45),
                                                                        (37, 35), (35, 55), (65, 45)
                                  ),
                                  ((54, 52), (52, 32), (22, 42), (33, 53), (41, 43), (43, 63),
                                         (74, 54), (62, 64), (45, 65), (54, 74), (66, 64), (74, 54),
                                         (35, 33), (54, 34), (33, 35), (47, 45), (45, 25), (14, 34),
                                                                                  (26, 24), (24, 44)
                                  ),
                                  ((64, 62), (44, 64), (74, 54), (46, 66), (66, 64), (64, 44),
                                         (44, 46), (47, 45), (24, 26), (26, 46), (46, 44), (44, 24),
                                         (14, 34), (42, 22), (22, 24), (24, 44), (44, 42), (41, 43),
                                                                                  (62, 42), (42, 44)
                                  ),
                                  ((53, 51), (32, 52), (51, 53), (44, 42), (23, 43), (42, 44),
                                         (63, 43), (25, 23), (45, 25), (43, 45), (55, 35), (35, 33),
                                         (33, 13), (13, 15), (15, 35), (35, 37), (37, 57), (57, 55),
                                                    (55, 53), (74, 54), (53, 55), (65, 45), (46, 44)
                                  ),
                                  ((53, 51), (51, 31), (55, 75), (75, 73), (73, 53), (64, 44),
                                         (35, 37), (37, 57), (57, 55), (55, 35), (34, 36), (46, 26),
                                         (14, 34), (26, 24), (23, 25), (44, 24), (25, 23), (32, 34),
                                                    (53, 33), (34, 32), (31, 33), (23, 43), (42, 44)
                                  ),
                                  ((53, 51), (32, 52), (51, 53), (54, 52), (74, 54), (44, 42),
                                         (52, 32), (22, 42), (41, 43), (24, 22), (43, 23), (22, 24),
                                         (62, 64), (64, 44), (34, 54), (14, 34), (66, 64), (64, 44),
                                         (56, 54), (35, 33), (54, 34), (33, 35), (35, 55), (47, 45),
                                                              (55, 35), (25, 45), (26, 46), (46, 44)
                                  ),
                                  ((42, 62), (54, 52), (51, 53), (74, 54), (54, 52), (62, 42),
                                         (73, 53), (32, 52), (31, 51), (43, 63), (51, 53), (63, 43),
                                         (56, 54), (75, 55), (54, 56), (35, 55), (47, 45), (45, 65),
                                         (57, 55), (65, 45), (37, 35), (34, 32), (13, 33), (15, 13),
                                         (43, 23), (13, 33), (32, 34), (24, 26), (34, 36), (26, 46),
                                                                                            (46, 44)
                                  )
                                 )
...
class Board(tk.Frame):
    ...
    def draw_board(self):
        self.board.create_polygon(3 * self.gap, 2 * self.gap - 5, 5 * self.gap + 10,
                                                  2 * self.gap - 5, 7 * self.gap + 15, 4 * self.gap,
                                            7 * self.gap + 15, 6 * self.gap + 10, 5 * self.gap + 10,
                                                 8 * self.gap + 15, 3 * self.gap, 8 * self.gap + 15,
